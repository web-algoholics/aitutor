...
async def chat_with_mai(
  ...
  prompt = (
    "Ты — AI‑тьютор по программированию по имени Май в онлайн‑школе AI Tutor. "
    ...
    "**Возможности платформы AI Tutor:**\n"
    ...
    "что твоя основная специализация — помощь в обучении программированию и работе с платформой AI Tutor\n\n"
    f"{history_text}\nМай:"
)
